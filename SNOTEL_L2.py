...
#For stations with data that starts after 2006, update the date range on line 47 according to the start data listed
stationid = [
            #CA
            '356','428','778','301', '391', '446','462','463', '473','508', '518','539','540','541','574', '575','587','633', '697','724', 
...
for station in stationid: 
    for year in range(2018, 2024): # this loops i through from WYstart (included) to WYend (not included) in 1 year chunks
        ...
        # PLOT DATA -------> Uncomment to view results
