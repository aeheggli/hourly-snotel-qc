...
@author: anne heggli anne.heggl@dri.edu
"""
import os
import pandas as pd 
import numpy as np
...
#uncomment stations to run QC
#For stations with data that starts after 2006, update the date range on line 64 according to the start data listed

stationid = [
            # #CA
            # '301', '356', '391','428','446','462','463','473','428','508','518','539','540','541','574','575','587','633','697','724', '771','784','778','809','834','846','848','977','1049','1050','1051','1052','1067', 
            # '1258', '1277', #data starts 2017
            # #NV
            # '321','334', '336','337','340','373','417','443','445','453','454','476','498','503','527','548', '569','570','573','615','652','698','746','750','811','849','1006',
            # '1110','1111','1112' #data starts 2008
            # '1136' #data starts 2009
            # '1147', '2170' #data starts 2010
            # '1137','1152','1155','1194','1195', #data starts 2011
            # '1242','1243','1244', #data starts 2013
            # '1262', #data starts 2015
            # '1258', #data starts 2017
            '1272' #data starts 2018
            # ]
...
for station in stationid:  
    ...
    for year in range(2018, 2024): # this loops i through from WYstart (included) to WYend (not included) in 1 year chunks
        #read L0 data
        ...
        ###### Uncomment to view data results ######
        # # PLOT DATA
